...
function initializeEventListeners() {
    ...
    // Admin functions
    document
        .getElementById("decryptTotalSupply")
        .addEventListener("click", decryptTotalSupply);
    document
        .getElementById("decryptBalance")
        .addEventListener("click", decryptBalance);
...
async function mintTokens() {
    ...
    const vInputs = document
        .getElementById("mintV")
        .value.split(",")
        .map((v) => parseInt(v.trim()));
    const rInputs = document
        .getElementById("mintR")
        .value.split(",")
        .map((r) => r.trim());
    const sInputs = document
        .getElementById("mintS")
        .value.split(",")
        .map((s) => s.trim());
...
async function burnTokens() {
    ...
    const vInputs = document
        .getElementById("burnV")
        .value.split(",")
        .map((v) => parseInt(v.trim()));
    const rInputs = document
        .getElementById("burnR")
        .value.split(",")
        .map((r) => r.trim());
    const sInputs = document
        .getElementById("burnS")
        .value.split(",")
        .map((s) => s.trim());
