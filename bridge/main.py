...
1. Mint WXMR when receiving mint requests and matching confirmed XMR deposits.
2. Burn WXMR and transfer XMR to receiver addresses when receiving burn requests.

For detailed diagrams and a full technical description of the minting flow, edge cases, and processing pipeline, see bridge/README.md (Technical Description).
"""
